                    ...
                    <Card>
                        ...
                        <Grid >
                            <Grid.Col span={11} pl={"15%"}>
                                ...
                                <SimpleGrid cols={4} spacing={"3rem"} justify="center">
                                    <h2></h2>
                                    <Text fz={"xl"} fw={700}>Present Time</Text>
                                    <Text fz={"xl"} fw={700}>Set Time</Text>
                                    <h2></h2>

                                    <Text fz={"xl"} fw={700}>Total Cycle Time</Text>
                                    ...
                                    <Text fz={"xl"} fw={700}>FWD Motor Time</Text>
                                    ...
                                    <Text fz={"xl"} fw={700}>Wait Time</Text>
                                    ...
                                    <Text fz={"xl"} fw={700}>REV Motor Time</Text>
                                    ...
                                    <Text fz={"xl"} fw={700}>Wait Time in Cycle</Text>
